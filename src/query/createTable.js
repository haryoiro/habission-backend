...
const createUsertaskTable = {
    ...
    "CREATE TABLE CREATE TABLE IF NOT EXISTS user_task(id serial primary key,user_id integer reference user(user_id), mission_id integer reference mission(mission_id),done boolean default false);"// クエリをここに書く
}
